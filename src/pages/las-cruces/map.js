  ...
  return (
    <>
      ...
      <main className="map page">
        {/* ─── Hero banner (same pattern as About) ───────────────── */}
        <section className="map-hero" aria-label="Location banner">
          {/* one image is fine here; let CSS pick cover/contain */}
          <Image
            src="/img/directions1200.jpeg"
            alt="Effy Exotics – find us in Las Cruces"
            fill           /* stretches to wrapper */
            priority
            className="banner-img"   /* ← key: ties into the small-screen contain rule */
          />
        </section>
